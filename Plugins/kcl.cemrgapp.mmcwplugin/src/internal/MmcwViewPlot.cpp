...
void MmcwViewPlot::OnSelectionChanged(berry::IWorkbenchPart::Pointer /*source*/,
...
void MmcwViewPlot::PlotData() {
    ...
    mitk::Surface::Pointer refSurf = strain->ReferenceAHA(lmNode, segRatios);
