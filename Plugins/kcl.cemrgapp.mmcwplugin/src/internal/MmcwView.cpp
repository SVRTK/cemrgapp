...
void MmcwView::CreateQtPartControl(QWidget *parent)
{
  ...
  connect(m_Controls.button_1, &QPushButton::clicked, this, &MmcwView::LoadDICOM);
  connect(m_Controls.button_2, &QPushButton::clicked, this, &MmcwView::ProcessIMGS);
  connect(m_Controls.button_3, &QPushButton::clicked, this, &MmcwView::SegmentIMGS);
  connect(m_Controls.button_4, &QPushButton::clicked, this, &MmcwView::CreateSurf);
  connect(m_Controls.button_5, &QPushButton::clicked, this, &MmcwView::TrackingIMGS);
  connect(m_Controls.button_6, &QPushButton::clicked, this, &MmcwView::LandmarkSelection);
  connect(m_Controls.button_7, &QPushButton::clicked, this, &MmcwView::Plotting);
  connect(m_Controls.button_r, &QPushButton::clicked, this, &MmcwView::Reset);

  //Set visibility of buttons
  m_Controls.button_2_1->setVisible(false);
  m_Controls.button_2_2->setVisible(false);
  m_Controls.button_2_3->setVisible(false);
  connect(m_Controls.button_2_1, &QPushButton::clicked, this, &MmcwView::ConvertNII);
  connect(m_Controls.button_2_2, &QPushButton::clicked, this, &MmcwView::CropinIMGS);
  connect(m_Controls.button_2_3, &QPushButton::clicked, this, &MmcwView::ResampIMGS);

  //Set visibility of buttons
  m_Controls.button_5_1->setVisible(false);
  m_Controls.button_5_2->setVisible(false);
  m_Controls.button_5_3->setVisible(false);
  connect(m_Controls.button_5_1, &QPushButton::clicked, this, &MmcwView::Tracking);
  connect(m_Controls.button_5_2, &QPushButton::clicked, this, &MmcwView::Applying);
  connect(m_Controls.button_5_3, &QPushButton::clicked, this, &MmcwView::Demoings);
