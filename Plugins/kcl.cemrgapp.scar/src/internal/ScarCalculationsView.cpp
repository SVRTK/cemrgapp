...
void ScarCalculationsView::CreateQtPartControl(QWidget *parent)
{
  ...
  connect(m_Controls.buttonPerformImageProcessing, &QPushButton::clicked, this, &ScarCalculationsView::DoImageProcessing);
}

void ScarCalculationsView::OnSelectionChanged(berry::IWorkbenchPart::Pointer /*source*/,
