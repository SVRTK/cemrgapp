...
void EASIView::OnSelectionChanged(berry::IWorkbenchPart::Pointer /*source*/,
        ...
        if (image) {
            ...
            try {
                ...
                if (dialogCode == QDialog::Accepted) {
                    ...
                    mitk::ProgressBar::GetInstance()->Progress();
                    AddToStorage("CGALMesh", mitkVtkGrid);
                    this->BusyCursorOff();
...
void EASIView::LoadMesh() {
    ...
    path = QFileDialog::getOpenFileName(
                ...
                directory, QmitkIOUtil::GetFileOpenFilterString());
    AddToStorage("Mesh", ReadVTKMesh(path.toStdString()));
}
...
void EASIView::AddToStorage(std::string nodeName, mitk::BaseData* data) {
...
mitk::Surface::Pointer EASIView::ReadVTKMesh(std::string meshPath) {
